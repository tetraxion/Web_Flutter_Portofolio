    ...
    return Expanded(
      ...
      child: Column(
        children: [
          ...
          SkillMenu(
            image1: 'assets/images/Dart.png',
            text1: 'Dart',
            image2: 'assets/images/flutter.png',
            text2: 'Flutter',
            image3: 'assets/images/python.png',
            text3: 'Python',
          ),
          SizedBox(
            height: defaultPadding,
          ...
          SkillMenu(
            image1: 'assets/images/htmlcssjs.png',
            text1: 'HTML, CSS, JS',
            image2: 'assets/images/php.png',
            text2: 'PHP',
            image3: 'assets/images/laravel.png',
            text3: 'Laravel',
          ),
          SizedBox(
            height: defaultPadding,
          ...
          SkillMenu(
            image1: 'assets/images/mysql.png',
            text1: 'Mysql',
            image2: 'assets/images/firebase.png',
            text2: 'Firebase',
